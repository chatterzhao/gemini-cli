...
// Define local types that may not be exported from core
...
export const SETTINGS_SCHEMA = {
  ...
  currentProvider: {
    ...
    showInDialog: false, // Managed through /auth and /model commands
  },
  currentModel: {
    type: 'string',
    label: 'Current Model',
    ...
    requiresRestart: false,
    default: undefined as string | undefined,
    description: 'The currently selected model name.',
    showInDialog: false, // Managed through /model command
  },
  customProviders: {
    type: 'object',
